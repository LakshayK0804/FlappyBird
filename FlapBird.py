...
class FlappyBird:
    ...
    def birdUpdate(self):
        ...
        upRect = pygame.Rect(self.wallx,360 + self.gap - self.offset+30,
                             self.wallUp.get_width() - 10,
                             self.wallUp.get_height())
        downRect = pygame.Rect(self.wallx,0 - self.gap - self.offset - 30,
                             self.wallUp.get_width() - 10,
                             self.wallUp.get_height())
    ...
    def run(self):
        ...
        pygame.font.init()
        font = pygame.font.SysFont("Desdemona",45)
        while True:
            clock.tick(60)
